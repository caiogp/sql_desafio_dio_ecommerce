...
select * from orcamento group by produto having sum(quantidade)>90;

select p.idPedido as Codigo_Pedido,p.pedidoStatus as situacao,c.Nome as Cliente from pedido p
